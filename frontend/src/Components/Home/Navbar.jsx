      ...
      <div className="nav__container">
        <div className="nav__header">
          <div className="nav__logo">
            ...
            <Link to="/">
              <span className="logo__text">Skill Journey</span>
            </Link>
          </div>

          <div className="nav__search">
            <form>
              <input type="text" placeholder="Search for skills, topics..." />
        ...
        <ul className={`nav__links ${menuOpen ? "open" : ""}`}>
          <li className="nav__item">
            <Link to="/services" className="nav__link">Projects</Link>
          </li>
          <li className="nav__item">
            <Link to="/specialists" className="nav__link">Mentors</Link>
          </li>
          <li className="nav__item">
            <Link to="/telehealth" className="nav__link">Courses</Link>
          </li>
          <li className="nav__item">
